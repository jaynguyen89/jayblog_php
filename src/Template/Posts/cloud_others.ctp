<div class="container">
    ...
    <ul class="breadcrumb">
        ...
        <li>Posts</li>
        <li><?= $this->Html->link('Server & Cloud', ['controller' => 'Posts', 'action' => 'cloudOthers']); ?></li>
    </ul>
    End breadcrumb -->
    ...
    <section id="content-1-9" class="content-1-9 content-block" style="padding-bottom: 10px;">
        ...
        <div class="container">
            <div class="underlined-title">
                <h1>Others: Server & Clouds</h1>
                <hr>
                <p class="lead">Section contains Jay's researches and practices on various kinds of Server & Clouds.</p>
            </div>
        </div>
        <!-- End section title -->
