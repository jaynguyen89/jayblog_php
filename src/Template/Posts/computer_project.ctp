<div class="container">
    ...
    <ul class="breadcrumb">
        ...
        <li>Posts</li>
        <li><?= $this->Html->link('Computer Applications', ['controller' => 'Posts', 'action' => 'computerProject']); ?></li>
    </ul>
    End breadcrumb -->
    ...
    <section id="content-1-9" class="content-1-9 content-block" style="padding-bottom: 10px;">
        ...
        <div class="container">
            <div class="underlined-title">
                <h1>Projects: Computer Applications</h1>
                <hr>
                <p class="lead">Section contains Jay's researches and practices on various kinds of Computer Applications.</p>
            </div>
        </div>
        <!-- End section title -->
