    ...
    <div class="row" style="min-height: 622px;">
        ...
        <div class="tab-content">
            ...
            <div id="suspendedPosts" class="tab-pane fade in active">
                <div class="row">
                    <?php foreach ($suspendedPosts as $post): ?>
                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-bottom: 45px;">
                            <div class="header" style="margin-bottom: 5px;">
                                <b style="font-size: 1.4em;"><?= $this->Html->link($post['title'], ['controller' => 'Posts', 'action' => 'view', $post->id]); ?></b>
                            ...
                            <div class="row">
                                <div class="col-sm-9 col-xs-9"><?= $post['description']; ?></div>
                                <div class="col-sm-3 col-xs-3">
                                    <?= $this->Form->postLink('Revive', ['controller' => 'Posts', 'action' => 'revive', $post['id']],
                                        ['class' => 'btn btn-outline btn-outline-sm outline-dim', 'confirm' => __('Revive post #{0}: {1}. Continue?', $post['id'], $post['title'])]); ?>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
