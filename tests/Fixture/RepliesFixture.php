...
class RepliesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reply_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        'replier_name' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => 'Unknown', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'replier_email' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => 'Unknown', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'comment_id' => 1,
            'reply_date' => '2018-02-19 04:28:35',
